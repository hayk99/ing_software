...
public class Test {
    ...
    public void createNoteTitleNull() {
        ...
        if (id > 0) {
            ...
            // La nota no se ha creado correctamente.
        } else {
    ...
    public void deleteCategory(){
        ...
        Long backCID = note.getLong(note.getColumnIndexOrThrow(NotesDbAdapter.NOTE_KEY_CATEGORY));
        if(backCID == 0){
